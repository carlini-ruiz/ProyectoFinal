  ...
  render() {    
    const altaa = ()=>{
      ...
      if(xhttp.responseText === "1"){
          console.log("Exito");
          Alert.alert(
              'Guardado Exitoso','Nuevo Tecnico Agregado', [{text: 'OK', onPress: () => console.log('ok'), style: 'cancel', }]);
      ...
      xhttp.open("GET","https://prograinter-proyecto.000webhostapp.com/HDCRegistroA.php?username="+this.state.Username+"&password="+this.state.Password+"&nombre="+this.state.Nombre+"&centro="+this.state.Centro, true);
...
<View style={styles.botons}>
    <TouchableOpacity onPress={altaa}>
